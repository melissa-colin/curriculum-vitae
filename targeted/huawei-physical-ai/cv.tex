...
{\small \textit{Final-year MEng student in computer science, writing a first-author paper toward CVPR 2027. I build a differentiable physics engine and neural models that output forces
...
\begin{itemize}
    ...
    \item \textbf{Languages:} French (native) $\cdot$ English \textbf{B2, TOEIC 840/990}, placement conducted entirely in English.
\end{itemize}
