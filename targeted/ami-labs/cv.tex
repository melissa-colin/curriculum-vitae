...
\begin{center}
    ...
    \faLinkedin~ \href{https://www.linkedin.com/in/melissacolin/}{linkedin.com/in/melissacolin} \quad|\quad
...
Wang, Y., Li, S., \textbf{Colin, M.}, et al. \textit{X-Dancers: Group Choreography as Masked Completion of a Formation-Grounded Motion Tensor.} Submitted to ICLR 2027 (Vision \& Learning Lab, University of Alberta).
...
\begin{itemize}
    \item Co-author on \textit{X-Dancers} (submitted to ICLR 2027), 3D group choreography generation in the lineage of masked-iterative methods (InterMask, ICLR 2025) and physics-based refinement (PhysDiff ICCV 2023, Morph ICCV 2025). Contribution: physically refined the motion data and produced the visualizations.
